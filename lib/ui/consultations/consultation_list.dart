      ...
      body: Container(
        ...
        child: Column(
          children: [
              ...
              child: Row(
                children: [
                 ...
                 if (_all == false)
                    ElevatedButton(
                      onPressed: () async {
                        filteredConsultations = await _httpHelper
                            ?.getMyConsultations(id!);
                        setState(() {
                          filteredConsultations = filteredConsultations;
                          _all = true;
                          _done = false;
            ...
            Expanded(
              child: filteredConsultations == null || filteredConsultations!.isEmpty
                  ? const Center(
                      child: Text(
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return ConsultationItem(consultation: filteredConsultations![index]);
                      },
                    ),
            ),
          ],
